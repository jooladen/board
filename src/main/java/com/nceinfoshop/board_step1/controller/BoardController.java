package com.nceinfoshop.board_step1.controller;
...
import com.nceinfoshop.board_step1.dto.BoardForm;
import com.nceinfoshop.board_step1.dto.BoardFormLombok;
import com.nceinfoshop.board_step1.entity.Board;
import com.nceinfoshop.board_step1.repository.BoardRepository;
...
public class BoardController {
	...
	public String boardView(Model model, 
		...
		model.addAttribute("boardDetail", boardRepository.findById(id).get());
		return "boardview";
	}
